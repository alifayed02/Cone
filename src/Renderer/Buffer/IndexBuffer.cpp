...
IndexBuffer::IndexBuffer(Context* context, const std::vector<uint16_t>& indices)
    :   m_Context{context}, m_Buffer{context, {indices.size() * sizeof(uint16_t), VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT, VMA_MEMORY_USAGE_AUTO, 0}},
